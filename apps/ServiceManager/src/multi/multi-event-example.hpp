// service_sample.hpp
#ifndef MULTI_EVENT_EXAMPLE_HPP
#define MULTI_EVENT_EXAMPLE_HPP
...
public:
    ...
    service_sample(uint32_t _cycle, int _service, vsomeip::instance_t instance_id, vsomeip::event_t event_id_);
