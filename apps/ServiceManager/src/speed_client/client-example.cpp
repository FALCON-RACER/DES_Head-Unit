...
// 확장성을 위해서 클래스 내부 변수로 인스턴스 아이디 등을 저장.
// for scalability, virtualize some functions
// abstraction..?
//  init
//      seperate init fun depends on subscribe or request 
//  on_message를    
//      to print data differently....
//   
...
// TODO:init 할때 message handler도 2개로 분할
// init 인자로 서비스 구분하여 가 아니고... 그 저기 뭐야 
// 클래스 안에 내부변수로 있으니까 그걸로 분할기준점을 잡으면될듯 

// 이벤트 그룹도 속도 / 배터리로 분할.
// 
client_sample::client_sample(bool _use_tcp) :
        app_(vsomeip::runtime::get()->create_application("speed")), use_tcp_(_use_tcp) {
}
